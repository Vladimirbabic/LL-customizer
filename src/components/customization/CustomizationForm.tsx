...
export function CustomizationForm({
  ...
  useEffect(() => {
    // Check if we already have an "Original template" entry in initial history
    const hasOriginalEntry = initialPromptHistory.some(item => item.id === 'original-template')
    ...
    if (!hasOriginalEntry) {
      ...
      setPromptHistory(prev => [originalEntry, ...prev])
    }
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []) // Only run on mount - intentionally using initial values
